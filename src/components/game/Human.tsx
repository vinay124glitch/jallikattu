...
const Human = ({ position, rotation, attached, color, actionName, actionId = 0 }: HumanProps) => {
  ...
  const animations = useMemo(() => {
    ...
    clips[10].name = "slash";
    return clips;
  }, [idleFbx, runningFbx, joggingFbx, dyingFbx, entryFbx, defeatedFbx, fallingFbx, flyingKickFbx, kneePunchFbx, hurricaneKickFbx, slashFbx]);
